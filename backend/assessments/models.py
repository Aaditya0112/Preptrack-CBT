...
class Exam(models.Model):
    ...
    # sections = models.ForeignKey('Section', on_delete=models.CASCADE, related_name='exams')

    # questions = models.ForeignKey('Question', related_name='exams', on_delete=models.CASCADE)
